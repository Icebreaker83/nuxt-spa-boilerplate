// Taken from: https://github.com/darrenfang/vuetify-datetime-picker/blob/4d5d64e3672c1d5fa53778e836ce607bad86bc91/src/components/DatetimePicker.vue
<template>
  <v-dialog
    v-model="display"
    lazy
    ...
    <v-card>
      ...
      <v-card-actions>
        ...
        <slot name="actions" :parent="this">
          <v-btn color="datetimepicker_clear_btn_color" text @click.native="clearHandler">
            {{ clearText }}
          </v-btn>
          <v-btn color="datetimepicker_ok_btn_color" text @click="okHandler">
            {{ okText }}
          </v-btn>
        </slot>
      </v-card-actions>
